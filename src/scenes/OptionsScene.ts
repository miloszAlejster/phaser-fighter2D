...
export default class OptionsScene extends Phaser.Scene{
    ...
    create(){
        // texts
        this.p1StartHp = this.add.text(this.scale.width/2, this.scale.height/4-30, "", { fontSize: '10px'}).setOrigin(0.5)
        this.p2StartHp = this.add.text(this.scale.width/2, 2*this.scale.height/4-30, "", { fontSize: '10px'}).setOrigin(0.5)
        this.immortality = this.add.text(this.scale.width/2, 3*this.scale.height/4-30, "", { fontSize: '10px'}).setOrigin(0.5)
        this.graphic = this.add.text(this.scale.width/2, this.scale.height-30, "", { fontSize: '10px'}).setOrigin(0.5)
        // inputs
        ...
        this.input.keyboard.on('keydown-LEFT', () => {
            ...
            }else if(this.idVCursor === 3){
                this.defaultGraphic = !this.defaultGraphic;
            }
        })
    ...
    handleSettingsChange(){
        ...
        if(this.defaultGraphic === true){
            this.defaultGraphicText = "Graphical"
        }else if(this.defaultGraphic === false){
            this.defaultGraphicText = "ASCII"
        }
        this.graphic.setText(`Type of graphic: ${this.defaultGraphicText}`)
    }
    handleChangeCursor(){
        if(this.idVCursor == 0){
            ...
            this.graphic.style.setFontSize('10px')
            ...
            this.graphic.style.setFontSize('15px')
            this.p1StartHp.style.setFontSize('10px')
            this.p2StartHp.style.setFontSize('10px')
            this.immortality.style.setFontSize('10px')
        }
